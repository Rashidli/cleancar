        ...
        <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    <h4>{{$about->translate('az')->title}}</h4>
                </div>
            </div>
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('abouts.index')}}">About</a></li>
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">{{$about->translate('az')->title}}</a></li>
                </ol>
            </div>
        </div>
        <div class="row">
                ...
                <form action="{{route('abouts.update', $about->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="mb-3">
                                <img  src="{{ asset($about->image) }}" class="uploaded_image" alt="{{$about->image}}">
