        ...
        <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    <h4>{{$statistic->translate('az')->title}}</h4>
                </div>
            </div>
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('statistics.index')}}">Statistika</a></li>
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">{{$statistic->translate('az')->title}}</a></li>
                </ol>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" name="az_title" value="{{$statistic->translate('az')->title}}">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" name="en_title" value="{{$statistic->translate('en')->title}}">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" name="ru_title" value="{{$statistic->translate('ru')->title}}">
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <textarea id="editor_az" class="form-control" type="text" name="az_content" >{{$statistic->translate('az')->content}}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="editor_en" class="form-control" type="text" name="en_content" >{{$statistic->translate('en')->content}}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="editor_ru" class="form-control" type="text" name="ru_content">{{$statistic->translate('ru')->content}}</textarea>
