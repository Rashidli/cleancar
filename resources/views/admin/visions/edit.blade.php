        ...
        <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    <h4>{{$vision->translate('az')->title}}</h4>
                </div>
            </div>
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('visions.index')}}">Niyə biz</a></li>
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">{{$vision->translate('az')->title}}</a></li>
                </ol>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" name="az_title" value="{{$vision->translate('az')->title}}">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" name="en_title" value="{{$vision->translate('en')->title}}">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" name="ru_title" value="{{$vision->translate('ru')->title}}">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="editor_az" class="form-control" type="text" name="az_content" >{{$vision->translate('az')->content}}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="editor_en" class="form-control" type="text" name="en_content" >{{$vision->translate('en')->content}}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="editor_ru" class="form-control" type="text" name="ru_content">{{$vision->translate('ru')->content}}</textarea>
                                @if($errors->first('ru_content')) <small class="form-text text-danger">{{$errors->first('ru_content')}}</small> @endif
                            </div>

                            <div class="mb-3">
                                <img  src="{{ asset($vision->image) }}" class="uploaded_image" alt="{{$vision->image}}">
                                <div class="form-group">
                                    <label >Niyə biz icon</label>
